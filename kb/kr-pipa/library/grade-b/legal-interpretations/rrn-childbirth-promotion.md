---
# === 식별 정보 ===
source_id: "b-interpretation-rrn-childbirth-promotion"
slug: "rrn-childbirth-promotion"
title_kr: "보건복지부 - 출산장려정책을 수행하기 위하여 불가피한 경우 주민등록번호를 처리할 수 있는지(「사회복지사업법 시행령」 제25조의2제2항 등 관련)"
title_en: ""
...
publisher: "법제처"
case_number: "14-0556"
decision_date: "2014-11-14"
source_url: "https://www.law.go.kr/DRF/lawService.do?OC=kipeum86&target=expc&ID=325065&type=HTML"
original_format: "json"
ingested_at: "2026-04-10"
mcp_id: "325065"

# === 검색 메타 ===
keywords: ["주민등록번호", "출산장려", "저출산고령사회기본법", "사회복지사업법", "제24조의2", "고유식별정보", "구체적 명시적 근거"]
...
# 보건복지부 - 출산장려정책을 수행하기 위하여 불가피한 경우 주민등록번호를 처리할 수 있는지
...
※ 법령정비 의견
출산장려정책 수행을 위해 불가피하게 주민등록번호 수집이 필요하다면 출산장려정책의 근거 법령인 「저출산ㆍ고령사회 기본법」 또는 같은 법 시행령에 주민등록번호 수집 근거를 마련하거나 「사회복지사업법」 제2조제1호에 「저출산ㆍ고령사회 기본법」을 추가할 필요가 있습니다.

## PIPA 조문 매핑
- 개인정보 보호법 제24조의2: 주민등록번호 처리는 법령이 "구체적·명시적"으로 요구·허용한 경우에만 가능함. 근거 법령(저출산·고령사회기본법)이 침묵하는 사안을 다른 법령(사회복지사업법 시행령)에 유추 포섭하여 주민번호 처리를 허용할 수 없음. 해석을 통한 근거 확장은 입법취지에 반함.
